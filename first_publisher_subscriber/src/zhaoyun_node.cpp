...
void zhaoyun_callback(std_msgs::String msg)
{
    if(msg.data == "Play a game?")
    {
        std_msgs::String response_msg;
        response_msg.data = "I'll take you to win!";
...
int main(int argc, char *argv[])
{
    ...
    ros::Subscriber subscriber = nodeHandle.subscribe<std_msgs::String>("kaihei_room", 3, zhaoyun_callback);
